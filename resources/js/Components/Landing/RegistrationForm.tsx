            ...
            <div className="mx-auto max-w-4xl">
                ...
                <div className="mb-20 text-center">
                    ...
                    <p className="mt-6 text-sm font-medium text-zinc-500">
                        Join the most prestigious basketball tournament in the region. One Fee:{' '}
                        <span className="font-black text-white">{fixedFee}</span>
                    </p>
                </div>
                            ...
                            {[1, 2, 3].map((s) => (
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        s <= step
                                            ? 'bg-brand-gold shadow-[0_0_8px_rgba(234,179,8,0.5)]'
                                            : 'bg-zinc-800',
                                    )}
                                />
                            ))}
                                        ...
                                        >
                                            ...
                                            {finalDivisions.map((d) => (
                                                <option key={d.id} value={d.id} className="bg-zinc-900">
                                                    {d.name}
                                                    {d.registration_fee ? ` (₱${d.registration_fee})` : ''}
                                                </option>
                                            ))}
                                        </select>
                                        {errors.division_id && (
                                        ...
                                        >
                                            ...
                                            <div className="grid grid-cols-1 gap-5 sm:grid-cols-3">
                                                ...
                                                <div className="sm:col-span-2">
                                                    ...
                                                    />
                                                    {errors[`players.${index}.name` as any] && (
                                ...
                                <div className="mt-6 flex items-center justify-between rounded-xl border border-white/5 bg-zinc-950/40 px-5 py-3">
                                    ...
                                    <span
                                        className={cn(
                                            ...
                                            data.players.length < 5 ? 'text-red-400' : 'text-brand-gold',
                                        )}
                                    >
                                        {data.players.length} / 12
                                        ...
                                        <label className="group block cursor-pointer transition-all">
                                            <div className="flex items-center gap-5 rounded-2xl border border-white/5 bg-zinc-900/50 p-5 transition-all group-hover:border-brand-gold/20 group-hover:bg-brand-gold/5">
                                                <input
                                                    ...
                                                    /* Large tap target */
                                                    className="h-6 w-6 cursor-pointer rounded border-white/10 bg-zinc-950 text-brand-gold transition-all focus:ring-brand-gold/30 shrink-0"
                                                />
                                                <span className="text-sm font-black tracking-tight text-zinc-300 transition-colors group-hover:text-white">
                                                    I certify that all personnel data is accurate and matches{' '}
                                                    <span className="text-brand-gold">Original PSA Certificates</span>.
                                                </span>
                                            </div>
                                        </label>
                                        ...
                                        <div className="rounded-2xl border border-brand-gold/10 bg-brand-gold/5 p-5">
                                            <div className="flex gap-4">
                                                ...
                                                <p className="text-[11px] leading-relaxed font-black tracking-[0.1em] text-brand-gold-glow uppercase">
                                                    NOTICE: Submission of falsified documentation will result in{' '}
